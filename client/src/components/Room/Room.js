        ...
        return (
            <div className="Room">
                ...
                <svg viewBox="0 0 1800 1012"
                    ...
                    <polygon display={isLoading?"none":"block"} onClick={this.props.makeTilesVisible} points="0,1001 0,829 456,573 461,594 789,594 937,613 1089,619 1142,770 1329,775 1336,705 1800,1010 0,1010" fill="yellow" opacity="0" />
                </svg>
